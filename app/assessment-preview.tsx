        ...
        <CardContent>
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <RadioGroup value="3" className="flex flex-col space-y-1 sm:flex-row sm:space-x-4 sm:space-y-0">
            ...
            <div className="space-y-4">
              ...
              <RadioGroup value="4" className="flex flex-col space-y-1 sm:flex-row sm:space-x-4 sm:space-y-0">
                <div className="flex items-center space-x-2">
