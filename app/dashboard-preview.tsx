      ...
      <header className="sticky top-0 z-40 border-b bg-background">
        <div className="container flex h-16 items-center justify-between py-4">
          <div className="flex items-center gap-2">
            <span className="text-xl font-bold">Coachability</span>
          </div>
          <div className="flex items-center gap-2">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Completed self-assessments</p>
                  <div className="mt-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">0</div>
                  <p className="text-xs text-muted-foreground">Awaiting referee responses</p>
                  <div className="mt-4">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-medium">Invite Referees</h3>
                        <p className="text-sm text-muted-foreground">
                          Nominate at least 2 people who know you well to provide feedback
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4">
